<details>
  <summary>Meeting 10.09.2025</summary>

# BlockQuiz
Code block based coding puzzles for kids

# Technology Entscheidung 
# Microsoft CodeBlocks vs Blockly 

# Ziel Lernplatform oder Hardwareblöcke 
# Ergebnisse: Webseite mit Lernplatfform SASS. 
# Use-cases: 
- Voklschulkinder 
- Hauptschulkinder
# Ziel Lernplattform oder Hardwareblöcke
</details>
...
This changes the scope and makes the database a bit more complex but a basic login should be no problem. A login with UIBK SAML/SSO might be a bit trickier. 
